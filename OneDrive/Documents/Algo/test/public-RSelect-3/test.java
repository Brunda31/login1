...
class Test {
    public static void main(String[] args) {
        ...
        try {
            ...
            outFile.write(", ");
            outFile.write(String.valueOf(c.RSelect(array, 60)));
            outFile.write(", ");
            outFile.write(String.valueOf(c.RSelect(array, 30)));
            outFile.write(", ");
            outFile.write(String.valueOf(c.RSelect(array, 20)));
            outFile.write(", ");
            outFile.write(String.valueOf(c.RSelect(array, 10)));
            outFile.write(", ");
            outFile.write(String.valueOf(c.RSelect(array, 50)));
            outFile.write(", ");
